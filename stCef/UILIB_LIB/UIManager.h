...
#define UISTATE_CAPTURED     0x00000040
	...
	public:
		...
		void SendNotify(CControlUI* pControl, DWORD pstrMessage, WPARAM wParam = 0, LPARAM lParam = 0);
		...
		void ChangePics(CStdStringPtrMap* pHashImage);
		BOOL ChangeUI(STRINGorID skn, STRINGorID xml, STRINGorID type, IDialogBuilderCallback* pCallback);
		BOOL IsExist(STRINGorID skn);
	private:
	...
	private:
		...
		CStdStringPtrMap m_mDefaultImageHash;
		CStdStringPtrMap* m_pmImageHash;
	...
	public:
		...
		LPCTSTR GetFtImage();
		void SetFtImage(LPCTSTR pStrImage);
		...
		virtual bool IsTrueVisible() const;
		...
		virtual void PaintFtImage(HDC hDC);
